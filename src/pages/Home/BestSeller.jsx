  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-28 px-4">
      <div className="text-center">
        ...
        A best seller is a highly popular book, product, or item that achieves exceptional sales, captivating audiences with its unique appeal, quality, and widespread demand across various markets. </p>
      </div>
