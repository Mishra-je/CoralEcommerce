...
const Register = () => {
  return (
    <section className="bg-gray-100 min-h-screen flex box-border justify-center items-center mx-auto">
      <div className="bg-yellow-500 rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
          ...
          <div className="mt-10 text-sm flex justify-between items-center container-mr">
            ...
            <Link to="/account"><button className="hover:border register text-white bg-blue-700 hover:border-blue-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">Login</button></Link>
          </div>
        </div>
        <div className="md:block hidden w-1/2">
          <img className="rounded-2xl max-h-[1600px]" src="https://images.unsplash.com/photo-1552010099-5dc86fcfaa38?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxmcmVzaHxlbnwwfDF8fHwxNzEyMTU4MDk0fDA&ixlib=rb-4.0.3&q=80&w=1080" alt="register form image" />
        </div>
      </div>
    </section>
  );
