...
export const client = [
  {
    ...
    text: "Excellent team!",
    feedback:
    "Excellent website! Great product variety, affordable prices, and super-fast delivery. Customer service is responsive and helpful. Shopping here was a breeze.",
  },
  {
    image: client2,
    name: "Ana Anderson",
    text: "Very good work",
    feedback:
      "Fantastic experience! My order arrived earlier than expected, perfectly packaged, and matched the description. Will definitely shop here again. Highly recommend.",
  },
  {
    image: client3,
    name: "Albert adame",
    text: "Very well",
    feedback:
    "Products were good quality, but delivery was delayed. Tracking information wasn’t accurate, causing inconvenience. Would shop again but hope for better logistics.",
  },
  {
    image: client4,
    name: "Dana Gilmore",
    text: "Excellent team!",
    feedback:
    "The items are nice and as described, but the packaging arrived damaged. Thankfully, the products were fine. Shipping process could use improvement."
    ,
  },
  {
    image: client5,
    ...
    text: "Excellent team!",
    feedback:
     "Ordered the wrong item, and customer support was slow to respond. Returns are complicated and expensive. Not a satisfying experience overall.",
  },
  {
    image: client6,
    name: "Sivay Ashbi",
    text: "Excellent team!",
    feedback:
     "Terrible service! My order never arrived, and nobody responded to my emails or calls. Completely disappointed and won’t shop here again."
  },
];
